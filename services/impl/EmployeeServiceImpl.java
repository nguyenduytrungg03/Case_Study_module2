    ...
    public void edit() {
        ...
        for (int i = 0; i < employeeList.size(); i++) {
            if (id == employeeList.get(i).getId()) {
                ...
                employeeList.get(i).setDateOfBirth(RegexPerson.regexAge());
...
//            System.out.println("nhập giới tính: ");
//            String gender = ExceptionInput.getGender();
                System.out.println("Nhập giới tính muốn sửa: 1.Nam\"+ \"2.Nữ");
                employeeList.get(i).setGender(ExceptionInput.getGender());

                System.out.println("Nhập CMND muốn sửa: ");
                employeeList.get(i).setIdCard(scanner.nextLine());

                employeeList.get(i).setPhoneNumber(RegexPerson.regexNumberPhone());

                employeeList.get(i).setEmail(RegexPerson.regexEmail());
...
//            String academyLevel = ExceptionInput.getAcademyLevel();
                ...
                employeeList.get(i).setAcademyLevel(ExceptionInput.getAcademyLevel());

                System.out.println("1.Lễ tân " + "," + " 2.Phục vụ" + "," + " 3.Chuyên viên" + "," + " 4.Giám sát" + "," + " 5.Quản lý" + "," + " 6.Giám đốc");
                System.out.println("Nhập vị trí muốn sửa: ");
                employeeList.get(i).setPosition(ExceptionInput.getPosition());
